  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "blob-medium": "blob 14s ease-in-out infinite 2s",
        "blob-fast": "blob 10s ease-in-out infinite 4s",
      ...
      boxShadow: {
        glass: "0 8px 32px rgba(22, 101, 52, 0.12)",
        card: "0 20px 50px -12px rgba(180, 83, 9, 0.15)",
      },
    },
  },
  plugins: [],
